...
N=size(TS2map,1);
B=cell(N,weight);
B=NVG_alg(TS2map,1,N,B,TT2map,weight); %  1,N ECEM
...
% [rel01,rel02,edge_VG]=find(VG);
% Graph00=graph(rel01,rel02,edge_VG);
% LWidths = 5*Graph00.Edges.Weight/max(Graph00.Edges.Weight);
% figure,plot(Graph00,'LineWidth',abs(LWidths)) %'EdgeLabel',G.Edges.Weight,
